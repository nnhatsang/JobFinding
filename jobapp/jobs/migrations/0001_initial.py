# Generated by Django 4.0.3 on 2023-08-19 07:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.BooleanField(choices=[('male', 'Male'), ('female', 'Female'), ('other', 'Other')], default='Male')),
        ...
        migrations.AddField(
            model_name='user',
            name='role',
            field=models.ForeignKey(blank=True, default=4, null=True, on_delete=django.db.models.deletion.CASCADE, to='jobs.role'),
        ),
        migrations.AddField(
            model_name='user',
